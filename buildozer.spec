...
# (str) Package name
package.name = callbreak

# (str) Package domain (needed for android/ios packaging)
package.domain = org.callbreak
...
# Exclude local build helper that contains notebook-style magics.
source.exclude_patterns = Build Callbreak APK.py
...
# Use unpinned python3 so python-for-android pulls a compatible version
...
# 1) android.add_assets = source_dir/file1,source_dir/file2
# 2) android.add_assets = source_dir
#android.add_assets =
...
# the default, you will be shown the license when first running
# buildozer.
# Note: already set above; duplicate entry removed to avoid configparser errors.
